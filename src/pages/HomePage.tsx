...
function LeftAvatar() {
  return (
    <div className="w-28 h-28 rounded-full border-2 border-[#8B7355]/60 bg-[#FFF0D0] flex items-center justify-center shadow-md overflow-hidden">
      <img src="https://juiceqiuqiu-1420133198.cos.ap-shanghai.myqcloud.com/1.jpg" alt="头像" className="w-full h-full object-cover rounded-full" />
    </div>
  );
}
...
function RightAvatar() {
  return (
    <div className="w-28 h-28 rounded-full border-2 border-[#8B7355]/60 bg-[#E6F3FF] flex items-center justify-center shadow-md overflow-hidden">
      <img src="https://juiceqiuqiu-1420133198.cos.ap-shanghai.myqcloud.com/2.jpg" alt="头像" className="w-full h-full object-cover rounded-full" />
    </div>
  );
}
