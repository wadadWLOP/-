          ...
          {checkinData.map((item) => (
            ...
            >
              ...
              <div className="text-4xl mb-2 relative z-10 mt-8">
                {item.id === 1 ? (
                  <img src="https://xxrbtbeehmfmtpkyahwg.supabase.co/storage/v1/object/public/diary-images/12.png" alt="" className="w-16 h-16 object-contain mx-auto" />
                ) : item.id === 2 ? (
                  <img src="https://xxrbtbeehmfmtpkyahwg.supabase.co/storage/v1/object/public/diary-images/13.png" alt="" className="w-16 h-16 object-contain mx-auto" />
                ) : ''}
              </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-6" style={{ backgroundColor: 'rgba(0,0,0,0.5)' }} onClick={closePolaroid}>
          ...
          >
            ...
            <div className="text-center">
              {selectedItem.id === 1 ? (
                <img src="https://xxrbtbeehmfmtpkyahwg.supabase.co/storage/v1/object/public/diary-images/12.png" alt="" className="text-6xl mb-4 w-20 h-20 object-contain mx-auto" />
              ) : selectedItem.id === 2 ? (
                <img src="https://xxrbtbeehmfmtpkyahwg.supabase.co/storage/v1/object/public/diary-images/13.png" alt="" className="text-6xl mb-4 w-20 h-20 object-contain mx-auto" />
              ) : (
                  ...
                  {records.map((record, index) => (
                    ...
                    >
                      <div className="text-2xl mb-1">
                        {record.item.id === 1 ? (
                          <img src="https://xxrbtbeehmfmtpkyahwg.supabase.co/storage/v1/object/public/diary-images/12.png" alt="" className="w-10 h-10 object-contain inline-block" />
                        ) : record.item.id === 2 ? (
                          <img src="https://xxrbtbeehmfmtpkyahwg.supabase.co/storage/v1/object/public/diary-images/13.png" alt="" className="w-10 h-10 object-contain inline-block" />
                        ) : (
                          record.item.emoji
                        )}
                      </div>
            ...
            <div className="text-center mb-4">
              <div className="text-5xl mb-2">
                {selectedRecord.item.id === 1 ? (
                  <img src="https://xxrbtbeehmfmtpkyahwg.supabase.co/storage/v1/object/public/diary-images/12.png" alt="" className="w-20 h-20 object-contain mx-auto" />
                ) : selectedRecord.item.id === 2 ? (
                  <img src="https://xxrbtbeehmfmtpkyahwg.supabase.co/storage/v1/object/public/diary-images/13.png" alt="" className="w-20 h-20 object-contain mx-auto" />
                ) : (
